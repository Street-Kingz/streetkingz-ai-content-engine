...
def generate_batch_plan(video_count, topics, clips, voice_library):
    selected_clips = []
    ...
    # Deduplicate by filename + folder
    seen = set()
    unique_clips = []
...
def main():
    ...
    result = generate_batch_plan(video_count, topics, clips, voice_library)
